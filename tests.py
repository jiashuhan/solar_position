...
jd = calendar2jd("2024-12-17 19:45:19") # Solar noon at San Diego (number obtained from Stellarium)

test_func = lambda x: np.minimum(np.abs(x), 360 - np.abs(x))
san_diego_noon = np.array(sun_location(jd, LAT, LON))
san_diego_noon_stellarium = np.array([33.774861, 180.00075])
san_diego_noon_plus_12 = np.array(sun_location(jd+0.5, LAT, LON))
...
equator_noon = np.array(sun_location(jd, 0, LON))
equator_noon_stellarium = np.array([66.61778, 180.00156])
equator_noon_plus_12 = np.array(sun_location(jd+0.5, 0, LON))
...
south_noon = np.array(sun_location(jd, -LAT, LON))
south_noon_stellarium = np.array([80.53133, 359.99625])
south_noon_plus_12 = np.array(sun_location(jd+0.5, -LAT, LON))
